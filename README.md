...
纯前端项目，所有数据（api，个性化数据，回答历史）均保存在本地。
...
- 🤖 **三贤者AI问答系统** - 支持多种AI提供商（OpenRouter【已测】、DeepSeek【已测】、OpenAI、Claude、Gemini等）
- 🎨 **EVA原作风格界面** - 完整还原动画中的MAGI系统视觉效果
- � **人格自定义系*统** - 支持自定义贤者名称、世界观背景和人格描述
- � **响应式设管计** - web端完整支持，移动端适配优化中
- � **历频史记录管理** - 完整的问答历史记录和详情查看
- 🔊 **音频效果系统** - 不同决策状态的音频反馈
...
系统支持以下AI提供商：
- **OpenRouter** - 统一API接口，支持多种模型
- **DeepSeek** - 国产AI模型，性价比高
...
#### 世界观背景设置
- 自定义背景故事，影响所有贤者的世界观认知
- 默认使用EVA原作中赤木直子博士的背景设定
- 支持完全自定义的世界观设定

#### 贤者人格配置
每个贤者支持以下自定义选项：
- **显示名称** - 自定义贤者在界面中的显示名称
- **副标题** - 贤者的身份描述（如"科学家"、"母亲"、"女人"）
- **人格描述** - 完全自定义的人格提示词，定义贤者的思维方式和回答风格

#### 默认人格设定
- **MELCHIOR-1 (科学家)** - 基于纯粹逻辑和数据分析的理性人格
- **BALTHASAR-2 (母亲)** - 基于责任感和道德伦理的保护性人格  
- **CASPER-3 (女人)** - 基于直觉和情感的感性人格
